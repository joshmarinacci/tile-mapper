...
export function LayerEditor(props: {
    ...
    const redraw = () => {
        if (ref.current) {
            ...
            if(handler) handler.drawOverlay({doc, layer, tile, ctx, grid, scale, selectedActor})
        }
    }
    ...
    return <div className={'vbox'}>
        ...
        {layer instanceof TileLayer && <TileLayerToolbar layer={layer} fillOnce={fillOnce} setFillOnce={setFillOnce}/>}
        {layer instanceof ActorLayer && <ActorLayerToolbar layer={layer} onSelect={setSelectedActor}/>}
