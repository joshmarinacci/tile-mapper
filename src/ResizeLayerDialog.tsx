...
import {MapCell, TileLayer} from "./datamodel"
...
export function ResizeLayerDialog(props: { layer: TileLayer }) {
    ...
    const doResize = () => {
        ...
        const data2:ArrayGrid<MapCell> = resizeArrayGrid(data,size, ArrayGridResizeAlignment.UPPER_LEFT, {tile:'unknown'} as MapCell)
    ...
    return <div className={'dialog'}>
        ...
        <footer>
            ...
            <button className={'primary'} onClick={doResize}>resize</button>
        </footer>
    </div>
}
