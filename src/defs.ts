import {ArrayGrid, Bounds, genId, Point, Size} from "josh_js_util"

import {DefList, PropDef, PropsBase, PropValues, UUID} from "./base"
import {
    drawEditableSprite,
    ImagePalette,
    JSONDoc,
...
export class Tile2 extends PropsBase<Tile2Type> {
    data: ArrayGrid<number>
    cache_canvas: HTMLCanvasElement | null
    palette:ImagePalette
    constructor(opts?:PropValues<Tile2Type>, palette:ImagePalette) {
        super({
            name: NameDef,
            blocking: BlockingDef,
...
export class TileLayer2 extends PropsBase<TileLayerType> {
    constructor(opts?:PropValues<Tile2Type>) {
        super({
            name: NameDef,
            type: NameDef,
            blocking: BlockingDef,
