...
export function ListSelect<T,O extends ListViewOptions>(props:{
    ...
    const showDropdown = () => {
        ...
        pm.show_at(<SelectionList data={data} renderer={Cell} selected={selected} setSelected={setSelected} options={options}/>,ref.current,"right")
    }
    return <button onClick={showDropdown} className={'list-select-button'} ref={ref}>
            <HBox>
