...
import {Doc2, Sheet2, Tile2} from "./defs"
...
export function TileSheetEditor(props: {
    ...
    const [sheet, setSheet] = useState<Sheet2>(doc.getPropValue('sheets')[0])
    const [tile, setTile] = useState<Tile2>(sheet.getPropValue('tiles')[0])
